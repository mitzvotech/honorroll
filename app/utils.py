...
def mail_bulk_csv(email_recipient):
    ...
    msg.html = '<p>Thank you for your interest in using the bulk upload \
        feature of the Pro Bono Honor Roll.</p><p>Attached to this email is a \
        template CSV file that you should use to upload the attorney \
        information. (If you have difficulty getting the attachment from this \
        email, you may download a copy at this link: \
        <a href="https://probonohonorroll.herokuapp.com/static/docs/\
        bulkattorneys.csv">https://probonohonorroll.herokuapp.com/static/docs/\
        bulkattorneys.csv</a>)</p> <p>Open the CSV file in Excel or similar \
        spreadsheet application. When you are done, please email the \
        completed CSV file to the following email address: XXXX.</p> \
        <p>If you have any technical difficulties, please email \
        Dave Zvenyach at <a href="mailto:dave@esq.io">dave@esq.io</a>.</p> \
...
def update_organizations(organization_name):
    connection.Organization.find_and_modify(
        {'organization_name': organization_name},
        update={'$set': {'organization_name': organization_name}},
