...
def send_confirmation(attorney_id, email_address):
	subject="Capital Pro Bono Honor Roll"
	body="<p>Thank you for registering for capitalprobono.org. To edit your entry, please click the following address: <a href='https://capitalprobono.org/attorneys/" + str(ObjectId(attorney_id)) + "?from_email=true'>https://capitalprobono.org/attorneys/" + str(ObjectId(attorney_id)) + "?from_email=true</a>.</p><p>If you have any difficulty, please contact capitalprobono@esq.io.</p><p>Thank you!</p>"
