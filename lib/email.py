...
def send_confirmation(attorney_id, email_address):
	...
	body="<p>Thank you for registering for capitalprobono.org. To edit your entry, please click the following address: <a href='https://capitalprobono.org/attorneys/" + str(ObjectId(attorney_id)) + "'>https://capitalprobono.org/attorneys/" + str(ObjectId(attorney_id)) + "</a>.</p><p>If you have any difficulty, please contact capitalprobono@esq.io.</p><p>Thank you!</p>"
